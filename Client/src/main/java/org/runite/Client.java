...
public class Client {
	 ...
	 * The game settings.
	 */
	public static GameSetting SETTINGS = new GameSetting("2009Scape", "135.181.45.222", 1, "live", false);
	...
	public static void main(String[]args) {
		try {
			PUBLIC_IP_ADDRESS = "135.181.45.222";
		} catch (Exception e){
		...
		Configurations.MS_IP = Configurations.LOCAL_MS ? "135.181.45.222" : PUBLIC_IP_ADDRESS; //Needs to be done because of order it's otherwise set
